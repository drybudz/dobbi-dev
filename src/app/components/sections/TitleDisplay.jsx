// components/sections/TitleDisplay.js
...
export default function TitleDisplay({ title, description }) {
      ...
      parallaxRef.current = gsap.fromTo(
        ...
        { y: 0 },
        {
          ...
          scrollTrigger: {
            ...
            id: 'TitleDisplay-parallax' // Add unique ID
          },
        }
      );
    }
  ...
  return (
    <section className={styles.TitleDisplay} ref={sectionRef} id="TitleDisplay">
